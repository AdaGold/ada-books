  ...
  describe "guest users" do
    ...
    describe "update" do
      ...
      it "will update a model with a valid post request" do
        ...
        book = Book.find_by(id: id)
        expect(book.title).wont_equal new_book_hash[:book][:title]
        expect(book.author.name).wont_equal authors(:madeleine_lengle).name
        expect(book.description).wont_equal new_book_hash[:book][:description]
      end
